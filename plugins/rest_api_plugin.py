...
apis_metadata = [
    ...
    },
    {
        ...
        "arguments": [
            ...
            {"name": "conn_uri", "description": "Connection URI, required to add a connection without conn_type", "form_input_type": "text", "required": False},
            ...
            {"name": "conn_host", "description": "Connection host, optional when adding a connection", "form_input_type": "text", "required": False},
            {"name": "conn_login", "description": "Connection login, optional when adding a connection", "form_input_type": "text", "required": False},
            {"name": "conn_password", "description": "Connection password, optional when adding a connection", "form_input_type": "text", "required": False},
            {"name": "conn_schema", "description": "Connection schema, optional when adding a connection", "form_input_type": "text", "required": False},
            {"name": "conn_port", "description": "Connection port, optional when adding a connection", "form_input_type": "text", "required": False}
        ]
    },
    {
        "name": "pause",
